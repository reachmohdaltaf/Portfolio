...
const Home = () => {
  return (
    <div className="flex flex-col text-start  gap-5">
     ...
     <h4 className='mt-3 leading-7'>I specialize in creating user-friendly digital experiences. Designed and developed full-stack web applications featuring <Link className="underline text-white cursor-pointer">RESTful APIs</Link>, user authentication, and dynamic front-end components.
     ...
     <h4 className='mt-3 leading-7'>As the Lead Organizer of the <Link className="text-white underline">Tech Fest</Link> at <Link className="underline text-white">SGGSJ College</Link>, I honed my leadership and organizational skills by coordinating a large-scale event that brought together students, educators, and tech enthusiasts. I managed event planning, delegated responsibilities, and ensured smooth execution of activities. The fest featured competitive programming, workshops, and innovative project displays, fostering a collaborative and inspiring environment for all participants.</h4>
     </div>
     <Separator/>
     <div>
     <h1 className='font-medium'>Personal Interests</h1>
     <h4 className='mt-3 leading-7'>Outside of work, I enjoy delving into <Link className="underline text-white">Psychology</Link>, exploring how the human mind works, and gaining new perspectives. I also cherish spending quality time with friends, which helps me unwind and stay connected. These interests keep me curious, grounded, and constantly learning.</h4>
     </div>
     <Separator/>
     <div>
